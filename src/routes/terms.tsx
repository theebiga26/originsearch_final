...
function TermsAndConditions() {
  return (
    <div className="min-h-screen bg-[#F5F3EF] text-[#1A2E22] font-sans selection:bg-[#C6F135] selection:text-[#1A2E22]">
      {/* Simple Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#F5F3EF]/90 backdrop-blur-md border-b border-[#1A2E22]/10 h-16 flex items-center px-6 sm:px-12 transition-all">
        <Link to="/" className="flex items-center gap-2 font-display font-bold text-sm hover:bg-[#1A2E22] hover:text-[#C6F135] bg-black/5 px-4 py-2 rounded-full transition-colors">
      ...
      {/* Content Container */}
      <main className="pt-32 pb-24 px-6 sm:px-12 max-w-4xl mx-auto
        [&_h1]:text-4xl sm:[&_h1]:text-5xl [&_h1]:font-display [&_h1]:font-bold [&_h1]:mb-8 [&_h1]:text-[#1A2E22] [&_h1]:tracking-tight
        [&_h2]:text-2xl sm:[&_h2]:text-3xl [&_h2]:font-bold [&_h2]:mt-14 [&_h2]:mb-6 [&_h2]:text-[#1A2E22] [&_h2]:font-display
        [&_h3]:text-xl sm:[&_h3]:text-2xl [&_h3]:font-semibold [&_h3]:mt-10 [&_h3]:mb-4 [&_h3]:text-[#1A2E22]
        [&_h4]:text-lg [&_h4]:font-semibold [&_h4]:mt-8 [&_h4]:mb-3 [&_h4]:text-[#1A2E22]
        [&_p]:text-base sm:[&_p]:text-lg [&_p]:mb-6 [&_p]:leading-relaxed [&_p]:text-[#1A2E22]/80
        [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-8 [&_ul_li]:mb-3 [&_ul_li]:text-base sm:[&_ul_li]:text-lg [&_ul_li]:text-[#1A2E22]/80 [&_ul_li]:leading-relaxed
        [&_strong]:font-bold [&_strong]:text-[#1A2E22]
        [&_a]:text-[#1A2E22] [&_a]:underline [&_a]:font-semibold hover:[&_a]:bg-[#C6F135] hover:[&_a]:text-[#1A2E22] [&_a]:transition-colors
      ">
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to originsearch.one, 601 W 5th Street,  Los Angeles, CA 90012, USA.</p>
</li>
<li>
...
<li>
<p><strong>Terms and Conditions</strong> (also referred to as &quot;Terms&quot;) means these Terms and Conditions, including any documents expressly incorporated by reference, which govern Your access to and use of the Service and form the entire agreement between You and the Company.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to originsearch.one, accessible from <a href="https://originsearch.one" rel="external nofollow noopener" target="_blank">https://originsearch.one</a></p>
</li>
<li>
...
<ul>
<li>By email: info@originsearch.one</li>
</ul>
